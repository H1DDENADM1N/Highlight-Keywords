...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_select_file.setText(QCoreApplication.translate("Form", u"\u9009\u62e9 \u6587\u4ef6 (F)", None))
#if QT_CONFIG(shortcut)
        self.pushButton_select_file.setShortcut(QCoreApplication.translate("Form", u"F", None))
#endif // QT_CONFIG(shortcut)
        self.pushButton_select_folder.setText(QCoreApplication.translate("Form", u"\u9009\u62e9 \u6587\u4ef6\u5939 (Shift + F)", None))
#if QT_CONFIG(shortcut)
        ...
        self.pushButton_edit_keywords.setText(QCoreApplication.translate("Form", u"\u7f16\u8f91 \u9ad8\u4eae\u5173\u952e\u5b57 (E)", None))
#if QT_CONFIG(shortcut)
        self.pushButton_edit_keywords.setShortcut(QCoreApplication.translate("Form", u"E", None))
#endif // QT_CONFIG(shortcut)
        self.pushButton_execute.setText(QCoreApplication.translate("Form", u"\u6267\u884c (Enter)", None))
#if QT_CONFIG(shortcut)
